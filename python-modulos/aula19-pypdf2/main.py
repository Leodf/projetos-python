...
with open('./python-modulos/aula19-pypdf2/pdf/novo_arquivo.pdf', 'rb') as arquivo_pdf:
    ...
    for num_pagina in range(num_paginas):
        ...
        with open(f'./python-modulos/aula19-pypdf2/novos_pdfs/{num_pagina}.pdf', 'wb') as novo_pdf:
